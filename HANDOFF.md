...
1. **Continue the ranked P0 figure queue** with Figure 3.9 (autonomic/HPA distinction), then Figure 4.9 (temporal/volley pitch coding), unless the instructor selects another figure.
