...
| `ch13-psychological-disorders-therapy.md` | `source/chapters/` | Chapter 13 markdown source — v0.2 (Session 73 spine-alignment pass), awaiting Jon's review |
...
**Files modified:**
- `source/chapters/ch13-psychological-disorders-therapy.md` — v0.1 → v0.2 (see above for full change list; header comment updated with full session changelog)
- `HANDOFF.md` — Status, Next Up (#2c), Key Files updated; this entry prepended
