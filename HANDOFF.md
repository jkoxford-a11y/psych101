...
**Next up:** Ch10 Lifespan Development is next in the spine-alignment backlog (Next Up #2c). The Ch9 word-count/trim decision is also open and could be picked up first if Jon prefers to address it before moving to Ch10.
