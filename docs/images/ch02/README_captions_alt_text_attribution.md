...
**Proposed placement:** Near the beginning of the chapter under “A Map Before the Details,” replacing the current evidence-ladder framing.  
**Proposed caption number:** Figure 2.1, pending final chapter-wide renumbering.  
...
**Proposed placement:** In the operational-definition section immediately after reliability and validity are introduced.  
...
**Proposed placement:** In Section 2 immediately after the paragraph introducing the correlation coefficient. Replace `fig_correlation_scatter.png`.  
**Proposed caption number:** Pending final chapter-wide renumbering.  
**Status:** **Use now after browser-checking.**  
