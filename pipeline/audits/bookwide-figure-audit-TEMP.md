...
| 4 | Figure 4.5 prediction loop resolved. Remaining: pitch coding, Weber graphic, color-processing boundary, same-pixels demonstration, and numbering control. |
| 5 | Open: Charles Bonnet mechanism framing and stale figure inventory. |
| 6 | Figures 6.2 and 6.3 resolved. Figures 6.1, 6.4, and 6.5 remain open. |
