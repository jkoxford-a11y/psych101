...
**Reconciled 2026-08-12.** A read-only audit compared all 105 rows against current chapter Markdown, each chapter's `pipeline/chNN-spine-seeds.md` record where one exists, and relevant `GPT_project_log.md` entries. Roughly 20 rows carried a Source citation that does not appear anywhere in the named chapter's text or reference list (the chapter's actual citation differed) — those Source fields were corrected to match what the chapter really cites. A handful of rows described content no longer present, or never installed, in the current chapter (stale status) — those were reworded or their status annotated to match reality. A few rows were internally stacked negations that, read as literal drafting instructions, would reintroduce the hedge-heavy sentence form the completed chapter audits deliberately removed — those were reworded toward affirmative framing without changing what they bind. No chapter prose was read for modification during this pass and none was changed. Full per-row classification: this session's transcript (not separately filed). The Ch13 Moncrieff chapter-text citation (still reading "2022" in body and reference list) remains a distinct, unapplied fix — see `HANDOFF.md`.
...
| Chemical imbalance | Evidence rejects a simple serotonin-deficiency account of depression; serotonin remains biologically relevant and antidepressants can reduce symptoms. | Moncrieff et al. (2023) | installed |
...
| Claim | Supported claim | Source | Status |
|---|---|---|---|
| Causal inference | Simple correlation establishes association. Causal conclusions require additional design or evidence; randomized experiments provide psychology's clearest causal test, while natural experiments, quasi-experiments, and strong longitudinal designs can also support them. | — | installed |
...
| Random sampling | Random sampling supports population representativeness. External validity is a separate question that also depends on how well the study context matches real-world conditions. | — | installed |
...
| Cortisol | Cortisol is one contributor to energy mobilization. Social-evaluative stress is not framed as evidence of evolutionary mismatch. | — | installed |
...
| Absolutes | Use scoped neuronal and synaptic language. Describe conduction (e.g., nodes of Ranvier) and clearance mechanisms without universal or exhaustive claims. | — | installed |
...
| Charles Bonnet syndrome | Internally generated activity contributes to the hallucinated content; retained insight that the images are unreal is characteristic. | Hamedani & Pelak (2019) | installed |
| Predictive processing | Present predictive processing as one candidate account of experience, not the settled explanation. | Clark (2013) | installed |
| AI "hallucination" | Use *hallucination* as a metaphorical and contested label. Distinguish next-token prediction from cortical predictive coding. | — | not installed — chapter currently contains no AI/LLM content; apply if this material is ever added |
...
| Little Albert | Use Little Albert as a flawed historical illustration: one participant, weak controls, ambiguous coding, and a mythologized record. | Harris (1979) | installed |
...
| Dopamine | Cue-evoked reward-prediction error and wanting or incentive salience are distinct findings. | Berke (2018), doi:10.1038/s41593-018-0152-y | installed |
| Intrinsic motivation | External rewards can reduce intrinsic motivation under specific conditions; state those conditions when teaching the effect. | Deci (1971) | installed |
...
| Claim | Supported claim | Source | Status |
|---|---|---|---|
| Confabulation | Human confabulation arises within autobiographical, motivational, affective, and source-monitoring systems and may be fantastic or foundationless. Language-model output is a different computational process. | Johnson, Hashtroudi & Lindsay (1993); Kopelman (1987) | installed |
| Survival processing | The survival-processing effect is broadly supported. Its evolutionary interpretation is one account alongside elaboration, distinctiveness, and scenario richness. | Nairne et al. (2007) | installed — repaired 2026-07-27 after the prior status proved false; re-verified 2026-08-12, forbidden strings confirmed absent |
| Patient H.M. | H.M. showed severe system-selective impairment together with limited new semantic learning. | Scoville & Milner (1957) | installed |
...
| Claim | Supported claim | Source | Status |
|---|---|---|---|
| Wason selection task | Present the difficulty in the Wason selection task as failure to identify diagnostic evidence, not attributable to one single mechanism. | Klayman & Ha (1987) | installed |
...
| Chomsky / poverty of the stimulus | Chomsky's critique established the inadequacy of strict behaviorism for language. Universal Grammar and poverty-of-stimulus remain disputed learnability arguments. | Chomsky (1965) | installed |
...
| Anchoring | The 1974 demonstration used a wheel-derived anchor and UN-membership estimates. | PMC8006283 | installed — the Chicago-population variant is not currently cited in the chapter |
| Linda / conjunction fallacy | The conjunction fallacy is robust but representation-sensitive; explicit frequency and nested-set formats sharply reduce errors. | Tversky & Kahneman (1983) for the fallacy; Gigerenzer (1991) for the format effect | installed |
| Group differences in test scores | Keep this topic retired from Chapter 9. If it returns elsewhere, rewrite this boundary as a plain affirmative statement rather than reusing this caveat-stacked wording; current evidence leaves genetic causation for socially defined group gaps unestablished, race and ethnicity are poor biological proxies, and stereotype-threat effects are context-sensitive. | 2024 meta-analysis (PMID 38421748); National Academies (2023) | retired from Ch. 9 by instructor decision, 2026-07-27; stereotype threat remains in Ch. 11 |
...
| Claim | Supported claim | Source | Status |
|---|---|---|---|
| Human life history | Use comparative primate claims and present the evolutionary account as a supported model. | Kaplan et al. (2000); Oxford & Geary (2019); Isler & van Schaik (2012); Flinn, Geary & Ward (2005) | installed |
| Life-history mosaic | Human slow development and longevity coexist with relatively short interbirth intervals and high reproductive output compared with other apes. | **Source attribution correction:** PMCID PMC7293148 is Richerson & Boyd (2020), not Bogin et al.; exact support for this boundary must be reverified if the topic returns. | retired from Ch. 10 by instructor decision, 2026-07-28; retain this record to prevent silent re-proposal |
| Attachment | Attachment is a relationship history, not a fixed destiny; sensitivity–security shows only a modest association with later functioning. The Strange Situation classifies relationship behavior under a procedure — not an enduring trait or an adult romantic style. | Madigan et al. (2024); Pinquart et al. (2020) | installed |
| Adolescent dual systems | A schematic account of average developmental tendencies produced by interacting systems; not two independent systems, not a universal reward peak, and not established as the cause of identity exploration. | Pfeifer & Allen (PMC6990093) | installed |
...
| Anthropomorphism | Treat anthropomorphism, the fundamental attribution error, and conformity as distinct constructs. A single AI answer supplies no consensus cue; name specifically which social mechanisms require a perceived mind. | — | installed |
...
| Claim | Supported claim | Source | Status |
|---|---|---|---|
| Constructionism | Present constructionism once as the chapter's chosen influential framework alongside alternatives. Treat classic theories as historical simplifications. | Barrett (2017a, 2017b) | installed |
...
| Hedonic adaptation | Hedonic adaptation is a descriptive well-being pattern. Dopamine reward-prediction error offers only a limited analogy to updating. | Brickman et al. (1978) | installed |
| Oxytocin / Heinrichs | Heinrichs et al. studied one small sample of healthy men using intranasal oxytocin; the finding is one window onto broader social-buffering effects rather than a standalone claim about "the bonding hormone." | Heinrichs et al. (2003) | installed |
...
| Serotonin and depression | A general serotonin-deficiency account of depression is unsupported, while antidepressants can reduce symptoms. Drug efficacy and disorder etiology are separate questions. | Moncrieff et al. (2023); Cipriani et al. (2018) | installed — chapter's own in-text citation and reference-list entry still read "2022"; separate open fix, see HANDOFF.md |
...
| Maintenance vs. origin | Avoidance, compulsions, and behavioral withdrawal explain how symptoms are sustained. Etiology and neurodevelopmental origin are separate questions addressed elsewhere in the book. | — | installed |
