...
- **Live-test the Chapter 8 Learning Labs** and decide where each should be linked from the canonical Chapter 8 source.
...
- **Commit/publish verification for the Prologue imagery edit** — confirm the current repository state and verify Figure P.5 on the live site before removing this item.
