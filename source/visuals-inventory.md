...
**Reconciled 2026-07-15** per `docs/images/ch02/CH02_IMAGE_WIRING_HANDOFF.md`; **re-audited and repaired 2026-07-28 from the rendered chapter** after the earlier review missed concrete defects in Figures 2.2, 2.3, 2.5, and 2.6. The nine-figure set remains wired into both `source/chapters/ch02-research-methods.md` and regenerated `docs/chapters/02-research-methods.html`, numbered sequentially by order of appearance. Desktop/mobile loading, default-width legibility, and expandable behavior were rechecked. `docs/images/ch02/README_captions_alt_text_attribution.md` is the authoritative Ch2 image manifest — consult it for captions, alt text, attribution, public-sharing status, and interpretation caveats.
...
| 2.9 | Effect size and confidence intervals (dot-and-whisker) | ✅ wired | `ch02/ch02_effect_size_confidence_intervals_magnitude_uncertainty.png` |
...
**Next action:** none for the canonical Chapter 2 figure set after the 2026-07-28 rendered audit. Optional cleanup of pre-existing unused/duplicate files remains in `PROJECT_BACKLOG.md`; it does not affect chapter rendering or publication status.
...
| — | Secondary altriciality brain-completeness comparison | — | held/skipped | Redundant if the human extended-development figure covers the mechanism. |
| — | Full Erikson lifespan arc | — | held/skipped | Skip because the chapter treats Erikson cautiously and should not over-visualize the full stage theory. |
