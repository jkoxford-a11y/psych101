...
|---|---|---|
| [Working memory (Baddeley model)](#section-1-encoding--building-the-trace) | Ch. 9 — Thinking, Language & Intelligence | Working memory capacity is a major individual-difference predictor of reasoning, problem-solving, and fluid intelligence measures |
...
| [Memory consolidation](#section-2-storage--from-synapse-to-system) | Ch. 6 — Sleep (review) | Sleep-dependent memory consolidation was anchored briefly in Ch. 6 specifically to be completed here; this chapter delivers the fuller mechanistic story |
| [Misinformation effect / eyewitness testimony](#section-4-when-memory-goes-wrong--reconstructive-memory-errors) | Ch. 11 — Social Psychology | Non-obvious: co-witness contamination of shared memories is a genuinely social phenomenon, not just an individual memory failure, and eyewitness identification errors have direct courtroom consequences this book returns to |
...
| [Flashbulb memories / emotional arousal and encoding](#section-4-when-memory-goes-wrong--reconstructive-memory-errors) | Ch. 12 — Emotion, Stress & Coping | Non-obvious: the same amygdala-mediated emotional arousal that makes flashbulb memories unusually vivid is covered mechanistically in full when emotion becomes the chapter's central topic |
| [Confabulation and source misattribution](#section-4-when-memory-goes-wrong--reconstructive-memory-errors) | Ch. 13 — Psychological Disorders & Therapy | The recovered-memory controversy in clinical practice — therapists potentially helping construct false memories of abuse during treatment — is a direct, ethically loaded application of this chapter's reconstructive-memory content |
