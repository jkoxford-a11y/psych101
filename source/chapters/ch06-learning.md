...
> Figures: none yet — open question for Jon, same status as every chapter so far. This chapter is the #1 priority for a new demo build per `pipeline/chapter-spec.md` §5 (a conditioning simulator covering CS/US pairing, reinforcement schedules, extinction, and negative reinforcement vs. punishment) — no such demo exists yet in the inventory, so no embed placeholder is included below; flagging the gap rather than placeholding for a demo that hasn't been built.
...
Chapter 5 closed by explaining how stimulant drugs hijack the dopamine system that ordinarily motivates pursuit of food, social connection, and other survival-relevant goals; this chapter opens up that same dopamine system and explains what it is doing the rest of the time — driving the ordinary, everyday process of learning what predicts what, and what behaviors pay off. Going forward, the conditioning principles introduced here are the direct ancestors of Chapter 13's behavioral therapies (extinction is, clinically, exposure therapy by another name), and the observational-learning content sets up Chapter 11's account of how social influence and aggression can spread through a population without any direct reinforcement of the people doing the learning.
...
This is **observational learning**: acquiring a new behavior by watching someone else perform it, with no direct reinforcement of the observer required at all. Bandura's own theoretical framework, social learning theory, breaks the process into four components: attention (the observer has to actually be watching), retention (the observed behavior has to be remembered), the capacity to reproduce the behavior physically, and motivation to actually perform it. That last component turned out to matter a great deal: a follow-up study found that children who watched the aggressive model get punished for the aggression were substantially less likely to imitate it themselves (Bandura, Ross, & Ross, 1963) — even though, by Bandura's own account, they had still learned the behavior through observation; they were simply less motivated to perform it. Bandura called this **vicarious reinforcement** (or vicarious punishment): learning that is shaped by watching someone *else* be reinforced or punished, without ever experiencing the consequence directly yourself.
...
| [Little Albert and conditioned fear](#classic-study-watson-and-rayners-little-albert) | Ch. 14 — Psychological Disorders & Therapy | Fear conditioning is a leading explanatory model for how specific phobias and some anxiety disorders develop in the first place |
...
| [Mirror neurons](#mirror-neurons-and-the-biology-of-watching) | Ch. 9 — Social Psychology (Theory of Mind) | A genuinely contested connection, flagged honestly here: mirror neurons are sometimes proposed as a biological substrate for understanding others' mental states, but — as this chapter notes — the strongest version of that claim (including the autism "broken mirror" hypothesis) has not held up well, which is itself a useful case study for Ch. 9's treatment of how an appealing mechanism can outrun its evidence |
| [Dopamine as anticipation, not pleasure](#section-4-dopamine-reward-and-why-learning-feels-the-way-it-feels) | Ch. 5 — States of Consciousness (review) | This chapter delivers in full the dopamine mechanism Chapter 5 previewed when explaining how stimulant drugs hijack the brain's reward pathway |
| [Intrinsic vs. extrinsic motivation](#section-4-dopamine-reward-and-why-learning-feels-the-way-it-feels) | Ch. 9 — Motivation & Emotion | The overjustification effect and the broader intrinsic/extrinsic distinction are foundational to self-determination theory, covered in full when motivation becomes the chapter's central topic |
