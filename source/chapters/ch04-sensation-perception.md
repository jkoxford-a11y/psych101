...
![Figure 4.3 — Left panel: simplified cross-section of the eye labeling the lens, pupil, retina, fovea, blind spot, and optic nerve. Right panel: line graph showing cone density peaking sharply at the fovea and rod density peaking in the periphery, with a dip at the blind spot.](../images/ch04/fig_retina_rods_cones.png)
...
![Figure 4.4 — Four-panel figure illustrating Gestalt principles: Panel A shows a vase-or-two-faces ambiguous figure for figure-ground; Panel B shows two clusters of dots for proximity; Panel C shows alternating circles and squares in a grid for similarity; Panel D shows incomplete circle and triangle outlines for closure.](../images/ch04/fig_gestalt_principles.png)
