...
<!--
  ...
  Figures (9 numbered; 2 unnumbered inline): see docs/images/ch04/README_captions_alt_text_attribution.md for full inventory.
  Demos: three labs pending — SDT simulator, Heider & Simmel motion demo, size-weight illusion. Replace placeholder lines with embed when live.
-->
...
> **Try it in the lab:** Adjust a detection criterion and watch how your hit rate and false-alarm rate trade off against each other: [Ch. 4 Interactive Labs → Signal Detection](../labs/ch04/sensation-perception-demos.html).
...
<!-- DEMO: Heider & Simmel — docs/labs/motion/demos/heider-simmel/ -->
> **Try it in the lab:** Watch an animation of geometric shapes and try to describe what they are doing without using intentional language — no "chasing," no "afraid," no "trying." Notice how hard that is: [Heider & Simmel Social Motion demo](../labs/motion/demos/heider-simmel/).
...
| [Signal detection theory](#section-1-the-basics--detecting-a-changing-world) | Ch. 13 — Psychological Disorders & Therapy | Clinical diagnostic decisions involve the same hit/miss/false-alarm/correct-rejection trade-off introduced here, with much higher stakes |
