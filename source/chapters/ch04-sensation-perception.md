...
> Draft v0.2 — 2026-06-21 | Status: revised per Jon's pass on an external (GPT) review, still needs Jon's own line-by-line review
> Word count target: 3,500–5,000 body words (currently ~4,480) | AI touchpoints: full (feature detection → convolutional neural networks; predictive coding → next-token prediction; extends the Tesla Vision signature analogy)
...
> Figures: none yet — open question for Jon, same as Ch1 and Ch3.
