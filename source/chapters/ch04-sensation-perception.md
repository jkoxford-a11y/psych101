...
![Figure 4.1 — Flowchart from physical stimulus through transduction, early neural preprocessing, and brain interpretation to perception, with a top-down feedback arrow from higher cortex back to early processing stages](../images/ch04/fig4_1_sensation_perception_pipeline.png)
...
![Figure 4.2 — Two-by-two matrix crossing stimulus present versus absent with observer says yes versus no, with the four cells labeled Hit, Miss, False Alarm, and Correct Rejection, each with a real-world example](../images/ch04/fig4_2_signal_detection_matrix.png)
...
![Figure 4.3 — Left panel: simplified cross-section of the eye labeling the lens, pupil, retina, fovea, blind spot, and optic nerve. Right panel: line graph showing cone density peaking sharply at the fovea and rod density peaking in the periphery, with a dip at the blind spot.](../images/ch04/fig4_3_retina_rods_cones_fovea_blindspot.png)
...
![Figure 4.4 — Four-panel figure illustrating Gestalt principles: Panel A shows a vase-or-two-faces ambiguous figure for figure-ground; Panel B shows two clusters of dots for proximity; Panel C shows alternating circles and squares in a grid for similarity; Panel D shows incomplete circle and triangle outlines for closure.](../images/ch04/fig4_4_gestalt_principles_panel.png)

*Figure 4.4. Gestalt principles describe how the visual system organizes separate elements into unified wholes. Each panel above can be "read" more than one way — notice that your perception, not the image, does the organizing.*
...
![Figure 4.5 — Left panel: uncoiled basilar membrane labeled with frequency regions from 20,000 Hz at the narrow base to 20 Hz at the wide apex, color-coded warm-to-cool. Right inset: a sound wave and matching neural spike train showing frequency theory's rate-coding at low pitches.](../images/ch04/fig4_5_cochlea_place_frequency_theory.png)
