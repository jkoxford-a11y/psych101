...
> Draft v0.6 — 2026-06-30 | Status: Batch revision (Session 50)
...
> Figures: 10 active figures. See `docs/images/ch03/README_captions_alt_text_attribution.md` for full inventory, captions, alt text, and attribution. Six are original generated figures (ChatGPT, 2026); two are CUNY Pressbooks CC BY 4.0; two are Jon's original lecture materials.
...
![Figure 3.8 — Flowchart showing a threat activating both the sympathetic nervous system for rapid bodily changes and the adrenal cortisol pathway for slower, longer-lasting effects](../images/ch03/fig_stress_response_fast_slow.png)
*Figure 3.8. A threat triggers two pathways at once: a fast neural route through the sympathetic nervous system (seconds) and a slower hormonal route through adrenal cortisol (minutes to hours). Section 2 covered the chemistry; this section covers the wiring.*
...
"Rest and digest" is more literal than it might sound. The **enteric nervous system** — the network of neurons embedded in the walls of the gut — contains over 100 million neurons and communicates bidirectionally with the brain via the vagus nerve, immune signaling, and metabolites produced by gut microbiota. Sympathetic activation suppresses gut motility and alters gut permeability; parasympathetic activity supports it. This is the defensible foundation for the observation that stress reliably affects GI function — not a simple "eat this → feel better" pipeline, but genuine two-way communication between brain and gut whose full behavioral implications are still being worked out.
...
The broader lesson generalizes: a real, well-replicated finding from an unusual clinical population got generalized, in popular culture, to a considerably less supported claim about ordinary brains. Watch for this pattern — it recurs constantly in how psychological findings reach general audiences.
