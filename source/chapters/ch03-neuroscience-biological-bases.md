...
> Draft v0.4 — 2026-06-27 | Status: spine v2.1 integration (action-selection framing, chemical imbalance correction, serotonin contrast, oxytocin as neuropeptide, gut-brain axis, fMRI tightened)
...
This chapter is about that machinery — what it is built from, how it signals, and how a small set of structures and chemicals produce the full range of what you think, feel, and do.
...
That framing also explains two phenomena that otherwise look unrelated. First, it explains why dopamine is so central to addiction: drugs of abuse hijack the same prediction and anticipation circuitry, making the cue that signals drug availability trigger the same kind of pursuit that natural rewards do. Second, it provides one framework for understanding why stimulant medications help many people with ADHD: they increase dopaminergic activity in prefrontal circuits, supporting the signal that sustains goal-directed attention. This is not the same as saying ADHD is caused by "low dopamine" — the full account involves multiple systems and the mechanism of stimulant effectiveness is still being worked out. The connection between dopamine, motivation, and learning is one of the deepest threads in this course, and one we return to repeatedly.

**Serotonin** is worth a brief contrast, precisely because it is the most commonly confused example. In popular accounts it is often called the "happiness chemical" — a claim that suffers from the same problem as "dopamine = pleasure." The more defensible account is that serotonin is often involved in behavioral inhibition, patience, and sustaining a course of action when waiting is adaptive — a functional complement to dopamine's role in redirecting toward new opportunities or signaling prediction mismatches. What serotonin does in any given circuit still depends on receptor type, circuit context, and what the organism is currently doing. This matters immediately for a widespread misconception most students arrive with, addressed in the callout below.
...
**The problem:** A 2022 umbrella review — the most comprehensive systematic review of this evidence to date — found no consistent evidence that people with depression have lower serotonin levels or reduced serotonin activity compared to people without depression (Moncrieff et al., 2022). The serotonin-deficiency model became widely familiar through drug advertising and simplified public explanations in the 1990s, not through scientific consensus.
...
The chapter question — *what does the biology of the brain tell us about behavior, and what does it leave out?* — runs through every section. The biology is most informative about mechanism and substrate; it is less informative about meaning, context, and what the organism is trying to do in its actual ecology. Holding both sides of that answer at once is what prevents both "the brain explains everything" and "the brain explains nothing."
...
Neurons communicate through an electrochemical process: dendrites receive input, the soma integrates it, and if accumulated input crosses a threshold, an all-or-nothing action potential fires down the axon, accelerated where the axon is myelinated. This model, established through Hodgkin and Huxley's work on the squid giant axon, generalizes across an enormous range of species — a clean example of the comparative method.

Chemical messengers operate at multiple scales. Neurotransmitters act locally across the synapse, exciting or inhibiting the next cell; many also function as neuromodulators, adjusting circuit sensitivity rather than simply flipping neurons on or off. Dopamine is the clearest example of why context and circuit define a chemical's meaning: its primary role is encoding prediction error — signaling the gap between expected and actual outcome — not producing pleasure. Serotonin is a useful contrast: it is more plausibly involved in behavioral inhibition, patience, and staying with a course of action when waiting is adaptive, not in happiness as a direct emotional state. Neuropeptides such as oxytocin occupy a third category: synthesized in the brain, released both centrally and into the bloodstream, with effects that depend heavily on context and circuit — facilitating affiliation in safe conditions, promoting vigilance in threatening ones. The enteric nervous system adds a further dimension: over 100 million gut neurons communicate bidirectionally with the brain, providing a real biological basis for gut-brain interactions that is more defensible than simplistic "mood food" claims.

The chemical imbalance framing of depression — that the condition is caused by low serotonin and corrected by restoring a deficit — is not supported by the evidence. A 2022 umbrella review found no consistent evidence of lower serotonin in people with depression (Moncrieff et al., 2022). Antidepressant efficacy is real; the deficit model is not what explains it. Neurotransmitter systems are components of circuits, and their role in behavior is defined by context, not absolute levels.

Hormones, including cortisol, coordinate whole-body responses more slowly through the bloodstream. The sympathetic and parasympathetic branches of the autonomic nervous system provide the fast, wired counterpart to the same stress response. Across both systems, the recurring evolutionary point is that these mechanisms were shaped for acute, time-limited demands — and much of their cost to modern humans comes from the mismatch between what they evolved for and how chronically they now get deployed.

The brain's major structures — the four cortical lobes, the limbic system, the hippocampus, the amygdala, the two hemispheres joined by the corpus callosum — show real functional specialization. The Phineas Gage and split-brain cases illustrate both what localization evidence can establish and how easily it gets overextended once it leaves the research literature for popular culture. The right conclusion is calibrated: specific regions are heavily involved in specific functions, the evidence is strong and converging, and any claim that becomes simple, dramatic, and personality-quiz-friendly should be treated with extra suspicion.
