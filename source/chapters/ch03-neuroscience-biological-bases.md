...
> Citation flag: 2024 Nature Neuroscience dopamine perspective — referenced in body text (RPE caveat paragraph) but full citation not yet verified. See References placeholder. Verify before publication.
> v0.5 changes (Session 49): (1) HTML sidebar corrected to 13-chapter TOC (removed stale Ch12 Motivation, Ch13 Stress & Health, Ch14 — now shows Ch12 Emotion/Stress/Coping, Ch13 Disorders/Therapy); (2) Where This Fits: "Chapters 12 and 13" updated to "Chapter 12" per current structure; (3) opener softened — radial organisms framing; (4) opener closing reframed as "constrain" rather than "produce"; (5) serotonin paragraph: Jon's exact wording (teaching contrast, not one-molecule summary); (6) ADHD sentence: NE added to DA; (7) Moncrieff claim: "of the major lines of evidence" replaces "most comprehensive"; (8) H.M.: "one of the clearest single pieces of evidence"; (9) demo placeholder renamed from "mixing board" to Dopamine Prediction Error; (10) lab placeholder added after chemical imbalance callout; (11) summary restructured to 5-paragraph hierarchy (action-selection → neurons → chemical messengers → stress/body → localization); (12) Carter (2014) added to References for oxytocin; (13) 2024 Nature Neuroscience dopamine ref flagged [verify].
...
> *[Lab link — Chemical Imbalance Claim-Check: Practice classifying claims about serotonin, antidepressants, and "chemical imbalance" as supported, overstated, or wrong/incomplete. Coming soon in docs/labs/.]*
...
*[Citation needed — verify 2024 Nature Neuroscience dopamine perspective before publication. Referenced in body text as arguing the classical RPE interpretation is incomplete; confirm authors, title, and volume/page before final draft.]*
