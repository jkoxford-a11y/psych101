...
![Figure 7.4. Characteristic cumulative-response patterns under four reinforcement schedules. Fixed ratio shows rapid responding with a post-reinforcement pause; variable ratio shows high, relatively steady responding; fixed interval shows a pause followed by acceleration as the interval elapses; variable interval shows steady, moderate responding. These are schematic laboratory patterns, not universal signatures of every organism or task.](../images/ch07/fig_reinforcement_schedules.png)
