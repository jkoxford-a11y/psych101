...
![Figure 7.7. Tolman and Honzik's cross-maze logic. A rat allowed to explore the maze freely, with no reinforcement, could still take a direct shortcut to a newly baited goal location from a novel starting point — evidence that it had built a cognitive map of the maze's layout during the unreinforced period, rather than learning nothing at all.](../images/ch07/fig_tolman_cognitive_map.png)
