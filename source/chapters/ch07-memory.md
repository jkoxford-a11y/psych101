...
| [H.M. and hippocampal memory](#section-2-storage--from-synapse-to-system) | Ch. 3 — Neuroscience & Biological Bases (review) | This chapter supplies the behavioral evidence for what the hippocampus actually does — Ch. 3 introduced the structure, this chapter shows what its loss costs |
| [Memory consolidation](#section-2-storage--from-synapse-to-system) | Ch. 5 — States of Consciousness (review) | Sleep-dependent memory consolidation was anchored briefly in Ch. 5 specifically to be completed here; this chapter delivers the fuller mechanistic story |
