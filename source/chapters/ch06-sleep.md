...
> [VOICE] markers flag places where Jon's specific lines/framings should be inserted before final draft.
...
| [Sleep deprivation and prefrontal-amygdala regulation](#section-3-sleep-deprivation-and-its-consequences) | Ch. 13 — Emotion, Stress & Coping | The amygdala-PFC circuit whose failure under sleep deprivation explains emotional dysregulation is the same circuit Chapter 13 returns to when explaining the neural mechanisms of stress reactivity |
