...
*Figure 6.1. Sleep is active maintenance, not downtime. Timing, sleep-stage architecture, memory reorganization, clearance, and broader biological regulation overlap and interact across the night. Original figure.*
...
*Figure 6.2. The light-to-SCN pathway and its downstream circadian outputs, simplified for teaching purposes. The anatomical inset places the paired SCN in the anterior hypothalamus immediately above the optic chiasm.*
...
![Figure 6.3: Two aligned graphs use separate vertical scales. Process S is sleep pressure: it rises during wakefulness and falls during sleep. Process C is circadian alerting: it rises and falls with biological time. Caffeine masks the Process S signal without clearing pressure, and a nap can discharge some pressure. Morning light, melatonin, and evening light act on circadian timing. High sleep pressure pushes toward sleep, while high circadian alerting supports wakefulness.](../../images/ch06/fig_process_s_process_c_levers.svg)
*Figure 6.3. The two-process model separates sleep pressure from circadian alerting. Process S rises during wakefulness and falls during sleep; Process C is an SCN-timed alerting rhythm. High S pushes toward sleep, whereas high C supports wakefulness. Caffeine and naps act on Process S; light and melatonin act on circadian timing. Original figure.*
...
#### Do Not Confuse: Sleep Paralysis and the Incubus Phenomenon
...
![Figure 6.4: A typical simplified eight-hour hypnogram showing repeated movement through wake, REM, and NREM stages. NREM 3 is concentrated in the first two cycles, while REM periods recur and lengthen toward morning. Three summary cards describe those architecture shifts without assigning restoration, memory, or regulation to exclusive clock blocks.](../../images/ch06/ch06_sleep_architecture_hypnogram_nrem_rem_cycles.svg)
*Figure 6.4. Sleep stage cycling across a typical night. Deep NREM sleep is concentrated earlier, REM recurs and lengthens toward morning, and stage proportions vary across cycles. The architecture shifts; sleep's biological functions overlap across stages and time.*
