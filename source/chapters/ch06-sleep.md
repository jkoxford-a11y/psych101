...
![Figure 6.1: The circadian pathway. Light arrives at the retina and travels via the retinohypothalamic tract to the SCN in the hypothalamus, which signals the pineal gland to release melatonin. The SCN maintains a free-running ~24-hour rhythm even without light input, demonstrating that the clock is internally generated; light entrains rather than generates it.](../../images/ch06/fig_scn_pathway.png)
*Figure 6.1. The circadian pathway from light input to melatonin release. Original figure.*
