...
> **Draft status:** v0.2 — revised this session per Jon's review.
>
> **Changes from v0.1:** Added "How to Use This Prologue" block; softened opener; added Ward et al. (2017) phone claim with narrow wording; corrected K-D Study 1 → Study 2; softened Ebbinghaus exact-percentage caption; revised AI memory/context language to be product-agnostic; reframed Clark & Brennan as applied communication framework; added Dunlosky et al. (2013) and Diekelmann & Born (2010); added Study Method Diagnostic table; added Do Not Confuse (deep ≠ long); added boxed AI study prompt; compressed sleep section; added metacognition row to Learning System table; added Study Contract box with download placeholder; wired P.3 and P.4 figure references; updated Further Reading.
>
> **Figures available:**
> - `docs/images/prologue/fig_forgetting_curve_ebbinghaus.png` — Ebbinghaus forgetting curve with spaced-review intervals (Section 4)
> - `docs/images/prologue/fig_dunning_kruger_actual_data.svg/.png` — Kruger & Dunning (1999) Study 2 logical reasoning data (Section 7)
> - `docs/images/prologue/learning_exposure_retrieval_decision_tree.svg/.png` — Exposure Is Not Learning decision tree (Section 3)
> - `docs/images/prologue/ai_replacement_vs_scaffolding.svg/.png` — AI replacement vs. scaffolding two-column diagram (Section 8)
>
> **Demo embeds:** Confirm live URLs with Jon before HTML conversion. Working memory demo: https://jkoxford-a11y.github.io/psych101_awesome-sauce/working-memory-demo.html
>
> **Download file needed:** `docs/assignments/prologue-study-contract.docx` — simple fillable Word doc matching the Study Contract box in Section 8. Build during final activities pass.
...
> **Stop & Retrieve:** Before moving on — what is the difference between selective attention and working memory? What happens to encoding when working memory is overloaded?
...
> **Do Not Confuse: deep processing ≠ long processing.** Spending more time with material is not the same as building meaning. You can reread a paragraph for thirty minutes and process it shallowly the entire time. Deep processing is about *what you do* with information — generating examples, making connections, explaining in your own words — not about how long you sit with it.
...
**Figure P.3 — Exposure Is Not Learning**
![Decision tree showing that rereading and recognition create familiarity, while recall and application provide stronger evidence of learning](../docs/images/prologue/learning_exposure_retrieval_decision_tree.png)
*Figure P.3. Use this flowchart to diagnose any study session: did you produce anything from memory, and did you apply it to a new case? Familiarity after rereading is weak evidence of learning. Recall and application are stronger evidence.*
...
> **Stop & Retrieve:** What is the testing effect? Why does it matter for how you study? (Answer without looking back.)
...
![Ebbinghaus forgetting curve showing rapid initial forgetting and how spaced review resets retention](../docs/images/prologue/fig_forgetting_curve_ebbinghaus.png)
*Figure P.1. Ebbinghaus (1885) showed that forgetting is steepest soon after learning — particularly for unfamiliar material — and then levels off. The exact rate depends on the material, the learner, and the task; Ebbinghaus used nonsense syllables and a savings/relearning measure, so his specific values should not be taken as a general law for all content. The key finding: each spaced review resets the curve, and the rate of forgetting slows with each successive retrieval.*
...
> **Stop & Retrieve:** Why does distributed practice typically outperform massed practice? Describe the mechanism, not just the result.
...
> **Stop & Retrieve:** Explain procrastination using the concept of negative reinforcement. Walk through the mechanism step by step — do not just name the concept.
...
![Bar chart showing Kruger and Dunning 1999 Study 2 logical reasoning data: perceived vs actual performance by quartile](../docs/images/prologue/fig_dunning_kruger_actual_data.png)
*Figure P.2. Kruger & Dunning (1999) Study 2: logical reasoning task. Actual vs. perceived test performance by quartile. The bottom-quartile group dramatically overestimated their performance (perceived ~62nd percentile; actual ~12th). The top-quartile group slightly underestimated theirs (perceived ~68th; actual ~86th). This is the actual finding — not the popular "Mount Stupid" spike curve, which does not appear in the paper.*
...
> **Stop & Retrieve:** What did Kruger and Dunning actually find? (Be specific — describe the pattern in Figure P.2.) What does this suggest about using your feelings of confidence to decide when you are done studying?
...
**Figure P.4 — AI Can Replace Retrieval or Support It**
![Two-column diagram comparing AI use that replaces student retrieval with AI use that critiques and strengthens a student's own explanation](../docs/images/prologue/ai_replacement_vs_scaffolding.png)
*Figure P.4. The difference between Nia's path and Luis's path is not whether AI was used, but when and how. AI that follows effort supports learning. AI that preempts effort replaces it.*

> **AI Study Prompt — Copy and Use**
>
> "Quiz me on [topic] one question at a time. Do not give me the answer until I respond. After I answer, tell me what I got right, what I missed, and ask one follow-up application question."

This prompt structure forces retrieval before feedback, and application before moving on. It turns AI into Luis's study system rather than Nia's.
...
> **Stop & Retrieve:** What is the grounding problem as it applies to AI? What practical implication does it have for how you set up prompts?
...
## Study Contract: Before the First Quiz

Use this before your first quiz. Schedule three retrieval sessions rather than one review session.

- **Retrieval Session 1:** ________ date / time
- **Retrieval Session 2:** ________ date / time
- **Retrieval Session 3:** ________ date / time
- **Material I will practice without looking:** ________
- **One thing I will do if I get stuck:** ________
- **One thing I will not count as studying by itself:** ________

[Download fillable version → `docs/assignments/prologue-study-contract.docx`]
...
1. Emma and Luis both spend two hours studying the same chapter. Emma rereads and highlights; Luis uses retrieval practice. Explain why their outcomes are likely to differ, using the concepts of encoding depth and the testing effect. **Model answer:** Luis's method practiced retrieval — producing information from memory — which strengthens future access to that memory more than re-exposure does. Emma processed the material shallowly (surface recognition); Luis processed it deeply and practiced the exact cognitive act the quiz demands. **Common mistake:** Saying Luis simply worked harder or cared more. The psychological explanation is about *what cognitive process was practiced*, not effort or motivation.

2. What is the difference between recognition and recall? Give one example of each from a psychology exam context. **Model answer:** Recognition is identifying correct information when it is present (e.g., picking the right definition from four choices). Recall is producing information without seeing it (e.g., defining "working memory" from memory). Recognition is typically easier because the answer is already in front of you. **Common mistake:** Treating them as the same because both involve "knowing" — the distinction is in what cognitive process the task demands, not in whether the student learned the material.

3. Explain why familiarity after rereading is an unreliable guide to how well you know material. Use the concept of metacognition in your answer. **Model answer:** Familiarity — the feeling that something looks or sounds recognizable — is produced by exposure and fluency, not by retrievable knowledge. Metacognition is the ability to accurately monitor what you know. Because the mechanism producing familiarity is partly independent of the mechanism producing retrieval, a student can feel ready after rereading and still fail to produce the concept on a test. **Common mistake:** Assuming that if something feels familiar, it has been learned. The prologue calls this the illusion of knowing.

4. A student claims she learns better by studying everything in one long Sunday session rather than across multiple shorter sessions. What does the research on massed vs. distributed practice predict about her long-term retention? **Model answer:** Research consistently shows distributed practice produces better long-term retention, even when total study time is equal. Each spaced session is a new retrieval event that resets the forgetting curve; massed practice provides only one. She may feel confident after the Sunday session — massed practice does produce short-term familiarity — but that confidence is likely to exceed her actual durable recall. **Common mistake:** Focusing on how she *feels* after cramming rather than on what the evidence predicts about retention a week later.

5. Use operant conditioning to explain why a student who feels anxious before studying might end up checking Instagram instead. Be specific about what is being reinforced and how. **Model answer:** The sequence is: (1) thinking about the exam produces anxiety; (2) the student checks Instagram; (3) anxiety drops temporarily; (4) because a behavior increased due to the removal of something aversive, this is negative reinforcement. The avoidance behavior becomes more likely in the future because it was reinforced. **Common mistake:** Describing this as laziness, weak willpower, or a character flaw. The operant account identifies a specific mechanism — negative reinforcement — that explains why avoidance persists even when the student knows it makes things worse.

6. Why does sleep deprivation harm learning in more than one way? Name at least two distinct mechanisms. **Model answer:** At minimum: (1) sleep loss degrades sustained attention, which is the gateway to encoding — you can be present but not encoding effectively; (2) sleep supports memory consolidation, the neural process by which recently encoded memories stabilize — material studied without subsequent sleep loses consolidation opportunity; (3) sleep deprivation impairs emotional regulation, making errors feel threatening rather than informative. **Common mistake:** Treating sleep as a single effect ("you're tired") rather than recognizing that attention, consolidation, and emotional regulation are each distinct systems that sleep supports independently.

7. According to Kruger & Dunning (1999) Study 2, which group showed the largest gap between perceived and actual performance? What does this finding suggest about using your own confidence as a study signal? **Model answer:** The lowest-performing quartile showed the largest gap — they scored around the 12th percentile on the logical reasoning task but estimated their performance around the 62nd percentile. This suggests that confidence after passive study is an unreliable signal, especially early in learning, because limited domain knowledge also limits the metacognitive ability to recognize gaps. External tests — retrieval practice, practice questions — are more reliable calibration tools than internal confidence. **Common mistake:** Assuming the Dunning-Kruger finding means "unintelligent people are overconfident." The actual finding is about calibration and domain knowledge, not general intelligence.

8. Nia used AI to get a chapter summary and felt prepared for the quiz. Apply the concepts of AI fluency and metacognition to explain what went wrong, and describe one specific thing she could have done differently to use AI in a way that would have supported learning. **Model answer:** AI produced fluent, organized output that activated the metacognitive signal of comprehension — Nia felt like she understood because the explanation made sense when she read it. But she never practiced retrieving or applying the concepts herself. The fluency of AI output is partly independent of whether the student has encoded anything retrievable. A specific alternative: after reading the AI summary, close it and ask AI to quiz her one question at a time, withholding the answer until she responds. This turns AI into a retrieval-practice tool rather than a substitute for it. **Common mistake:** Concluding that Nia simply should not have used AI. The better answer distinguishes *how* AI was used (replacement for retrieval) from *how it could have been used* (scaffold for retrieval).
...
**negative reinforcement** — An increase in behavior because it removes or reduces something aversive; relevant to procrastination and avoidance.
...
**Dunlosky, J., Rawson, K. A., Marsh, E. J., Nathan, M. J., & Willingham, D. T. (2013).** Improving students' learning with effective learning techniques. *Psychological Science in the Public Interest, 14*(1), 4–58. — The systematic review that ranks ten common study strategies by utility. Practice testing and distributed practice come out on top; highlighting and rereading are at the bottom when used as primary methods. Surprisingly readable for a 50-page review paper; the table of ratings alone is worth the download.

**Roediger, H. L., & Karpicke, J. D. (2006).** Test-enhanced learning: Taking memory tests improves long-term retention. *Psychological Science, 17*(3), 249–255. — The primary empirical paper behind the testing effect. Short, well-designed, and the retention graphs tell the story clearly.

**Diekelmann, S., & Born, J. (2010).** The memory function of sleep. *Nature Reviews Neuroscience, 11*(2), 114–126. — The most accessible comprehensive review of sleep and memory consolidation. Covers declarative and procedural memory separately and explains the hippocampal-neocortical dialogue during slow-wave sleep.

**Dunning, D. (2011).** The Dunning-Kruger effect: On being ignorant of one's own ignorance. *Advances in Experimental Social Psychology, 44*, 247–296. — A full review of the metacognitive accuracy literature by one of the original authors. More nuanced than the internet's version of the finding; explains calibration, not just overconfidence.

**Noba Project — "Memory (Encoding, Storage, Retrieval)" (Sherrill).** Free, peer-reviewed, open-access module covering the memory science behind Sections 2–4 of this prologue. Available at noba.to.
