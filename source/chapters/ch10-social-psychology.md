...
Social psychology bridges the gap between the individual and the social world. This chapter builds directly on attribution and dual-process reasoning from Chapters 1 and 8, conditioning and observational learning from Chapter 6, and memory reconstruction from Chapter 7. Everything here — how we judge others, how we yield to or resist social pressure, how groups make decisions, how we help or harm — connects forward to personality (Chapter 11) and motivation and emotion (Chapter 12).
