...
Consider this case. A man with complete damage to his primary visual cortex — cortically blind, with no reportable visual experience — was placed at one end of a long hallway. The hallway was full of obstacles: boxes, a filing cabinet, a wastepaper bin placed at irregular intervals. He was told the hallway was empty. Encouraged to walk to the other end, he hesitated — he could see nothing, he said — but began to move. He reached the far end without a single collision. Weaving around every obstacle, navigating the space as if he could see it. Asked afterward how he had managed it, he said he had no idea (de Gelder et al., 2008).

His brain was receiving and processing visual information. It was processing that information well enough to guide his body through a complex physical space. None of it ever became a conscious experience.

This is **blindsight** — and it breaks the assumption buried in the misconception above. A great deal of what your brain does with sensory input never enters awareness at all. Consciousness and information processing are not the same thing.

![Figure 5.1 — A cortically blind man walks down an obstacle-filled hallway, successfully weaving around cones and a plant while reporting no visual awareness of them; his conscious report ("I have no idea") is dissociated from the unconscious processing that guided his steps.](../images/ch05/blind_sight.png)
*Figure 5.1. Blindsight: visual information can guide behavior — walking around obstacles — without ever producing a conscious visual experience of them (de Gelder et al., 2008).*

You almost certainly have a version of this in your own experience. Have you ever driven a familiar route, arrived safely, and realized you have no memory of the last ten minutes of the trip? The car stopped at red lights, navigated turns, avoided other vehicles — all of it successfully. Nobody was home.

This chapter's question is what it means to be home: what consciousness actually is, why evolution built it, what neural systems maintain it, and what happens when you chemically disrupt those systems. The answer is not a complete one — the deepest question about consciousness remains genuinely unresolved, as this chapter will be honest about at the end. But a working framework that is scientifically productive, empirically grounded, and teachable is available. That is what we will build here.

---

## Where This Fits

Chapter 4 established that perception is not a passive recording of the world but an active construction — the brain generates predictions about incoming sensory signals and updates them based on mismatch between prediction and input. This chapter asks what it means for that constructed signal to become *experience*: subjective, felt from the inside, reportable.

Chapter 4 also flagged that selective attention — which signals get promoted into awareness — would be resolved here. It is.

This chapter also introduces the neurochemical mechanisms behind major drug classes. Those mechanisms feed directly into Chapter 7 (Learning), where the dopamine reward-prediction-error system introduced here becomes the basis for understanding reinforcement. Chapter 6 (Sleep) takes the predictive model established here and asks what happens to it overnight — how sleep maintains the model, and what breaks when maintenance fails.
