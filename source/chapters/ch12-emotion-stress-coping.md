...
<!-- Version: 0.2 (2026-06-24) — review corrections applied: Barrett framing softened,
     ...
     1998a/1998b disambiguation, Torre "review" not "meta-analysis", claims softened. -->
<!-- Replaces ch12-motivation-emotion.md entirely — different chapter design agreed with Jon 2026-06-24 -->
<!-- Concepts covered: MOT-004 (theories of emotion), MOT-005 (basic emotions/Ekman — brief),
     MOT-006 (GAS/Selye), MOT-007 (fight-or-flight/tend-and-befriend), MOT-008 (coping styles)
     MOT-001/002/003 dropped by design decision (Maslow, intrinsic/extrinsic, SDT — out)
     New content added: allostasis/body budget (Barrett framework), emotional granularity,
     affect labeling, allostatic load (McEwen) -->
<!-- Copyright note: MOT-004 remains book-adoption flagged. Content sourced from verified
     primary literature (James 1884; Cannon 1927; Schachter & Singer 1962; Barrett 2017a book
     + Barrett 2017b SCAN paper) and primary literature. No course-material wording used. -->
<!-- Citation note: All citations independently verified. Programmatic cross-check at end. -->

---

## Misconception Opener: "Emotions happen to you — they're reflexes you can't control."
...
> **Why it matters:** College students consistently underestimate how much their emotional life is affected by basic maintenance factors — sleep, food, exercise, social contact. This chapter provides the biological rationale for why those factors are not incidental to emotional regulation but central to it.
...
1. Distinguish allostasis from homeostasis and explain the concept of the body budget.
2. Define interoception and core affect, and explain how the brain uses them to construct emotional experience.
3. Identify the James-Lange, Cannon-Bard, and Schachter-Singer theories and explain what Barrett's constructionist account adds.
4. Define emotional granularity and describe the affect-labeling effect and its implications.
5. Describe Selye's General Adaptation Syndrome and its three stages.
6. Contrast fight-or-flight and tend-and-befriend stress responses, and explain the concept of allostatic load.
7. Distinguish problem-focused from emotion-focused coping and identify conditions under which each is more effective.
...
> **Do Not Confuse: Emotion vs. Mood**
...
## AI Connection: Does AI Have Feelings?
...
**affect labeling** — the process of putting emotional experiences into words; reduces amygdala activation and functions as implicit emotion regulation

**allostasis** — the maintenance of bodily stability through anticipatory, predictive adjustment rather than reactive correction

**allostatic load** — the cumulative physiological cost of repeated or sustained stress-response activation; associated with immune suppression, cardiovascular risk, and cognitive impairment

**body budget** — Barrett's term for the brain's allostatic management of the body's metabolic and social resources
...
**emotional granularity** — the degree to which a person makes fine-grained distinctions among emotional states; higher granularity predicts better coping and mental health
...
**interoception** — the brain's continuous monitoring of internal body states including heart rate, gut signals, muscle tension, and metabolic signals

**James-Lange theory** — the proposal that emotions arise from the perception of physiological bodily changes

**mood** — a diffuse, lower-intensity, prolonged affective state reflecting background body-budget status rather than a specific event

**primary appraisal** — the initial evaluation of whether a situation is relevant to one's wellbeing and whether it is threatening, harmful, or challenging

**problem-focused coping** — coping strategies that target the stressor directly, aiming to reduce or eliminate its source

**Schachter-Singer two-factor theory** — the proposal that emotion consists of undifferentiated physiological arousal plus a cognitive label assigned from context

**secondary appraisal** — the evaluation of one's available resources and options for coping with a stressor

**social support** — tangible, informational, and emotional resources provided by social relationships; directly reduces allostatic load and stress reactivity

**stressor** — an event or condition appraised as taxing or exceeding one's coping resources

**oxytocin** — a neuropeptide involved in social bonding and affiliation; interacts with social support to buffer cortisol responses to stress

**tend-and-befriend** — a stress response pattern involving nurturant and affiliative behavior, particularly evident in females, mediated in part by oxytocin

**theory of constructed emotion** — Barrett's account of emotion as a prediction generated by the brain from interoceptive signals, core affect, and learned emotion concepts
...
- Barrett, L. F. (2017). *How Emotions Are Made: The Secret Life of the Brain*. Houghton Mifflin Harcourt. — The primary source for the constructionist framework; written accessibly for non-specialist readers.
- Sapolsky, R. M. (2004). *Why Zebras Don't Get Ulcers* (3rd ed.). Holt. — The most readable account of stress biology available, with characteristic evolutionary framing; highly recommended alongside this chapter.
- McEwen, B. S. (1998a). Protective and damaging effects of stress mediators. *New England Journal of Medicine*, 338, 171–179. — A foundational paper on allostatic load; accessible and short.
...
<!-- MOT-004 Theories of emotion (James-Lange / Cannon-Bard / Schachter): covered in Section 2 ✓ -->
<!-- MOT-005 Basic emotions / Ekman: covered in Section 2 (brief, as note) ✓ -->
<!-- MOT-006 Stress and GAS (Selye): covered in Section 3 ✓ -->
<!-- MOT-007 Fight-or-flight / tend-and-befriend: covered in Section 3 ✓ -->
<!-- MOT-008 Coping styles (problem-focused / emotion-focused): covered in Section 4 ✓ -->
...
<!-- Activity ideas (log, do not build):
     ...
     - Granularity exercise: students rate their current state on a 20-item emotion word list; discuss how many distinct states they can identify vs. collapsing to "good/bad"
     - Coping strategy matching: present 6 stress scenarios varying in controllability; students choose problem vs. emotion-focused and justify
     - AI affect-labeling check (chatbot prompt, assignments layer only — do NOT put inline):
       Prompt: "Give me three possible emotion labels for this situation: [student describes a stressor].
       For each label, explain what coping response it would imply. Do not tell me which is correct."
       Students then evaluate whether the label fits evidence from their own body state, context, and
       actual problem. Teaches granularity and AI use without outsourcing self-reflection. -->

<!-- Demo ideas (log, do not build):
     - Core affect circumplex: interactive 2D plot where students place their current state; class overlay shows distribution; updates in real time
     - Body-budget ledger: students make deposits/withdrawals across a simulated day; watch effect on "emotion construction quality" — visualizes allostatic logic
     - GAS timeline: animated diagram showing cortisol/immune function across three stages with clickable consequences at each stage -->
