...
> Drafting history & provenance: see `_provenance/ch12-emotion-stress-coping.md` (and git log).
...
> **Think About It:** A teammate says, "I feel bad about our project." Without asking for private health information, what questions could distinguish disappointment, frustration, and anxiety—and how might the first useful action change?
...
![Three-part comparison. A top strip labels alarm, resistance, and exhaustion as Selye's historical heuristic without a numerical curve. Below, one path shows short-term mobilization followed by recovery; a second shows repeated or unresolved demands with inadequate recovery leading to interacting immune, metabolic, cardiovascular, sleep, and behavioral costs labeled allostatic load. The closing line reads Useful in the short run; costly when left running.](../../docs/images/ch12/fig_general_adaptation_syndrome.png)
*Figure 12.4. GAS supplies historical labels for prolonged stress; allostatic load better represents cumulative, multisystem costs when demands repeat or recovery is inadequate. There is no universal depletion curve. Original figure.*
...
> **Do Not Confuse: Acute Adaptation vs. Chronic Dysregulation**
...
> **Stop and Retrieve:** A student receives confusing instructions for a paper and is too activated to read them carefully. Identify the controllable part, the current arousal problem, and a two-step coping sequence. Why would either strategy alone fit poorly at first?
...
[Open the Coping Fit Learning Lab](../../docs/labs/ch12/coping-fit.html)
...
> **Think About It:** A club event has low attendance. Which parts are controllable before the next event, which feelings may need regulation now, and what information would tell you whether to switch strategies?
...
|---|---|---|
| [SAM, HPA, and allostasis](#fast-sam-slower-hpa-interacting-consequences) | [Chapter 3 — Neuroscience & Biological Bases](03-neuroscience.html) | The biological systems introduced there become interacting response routes here |
| [Hedonic adaptation](#hedonic-adaptation-and-the-chapter-7-bridge) | [Chapter 7 — Learning](07-learning.html) | Reward-prediction error is an adjacent learning process, not the established mechanism of well-being adaptation |
| [Social support and regulation](#supporting-the-conditions-for-flexible-coping) | [Chapter 10 — Lifespan Development](10-lifespan-development.html) | Relationships can support regulation across development through several pathways |
| [Emotion-shaped AI output](#ai-connection-emotion-shaped-output-without-a-human-body) | [Chapter 11 — Social Psychology](11-social-psychology.html) | Social perception encourages people to infer minds and feelings from fluent behavior |
| [Chronic dysregulation](#gas-as-history-allostatic-load-as-the-contemporary-frame) | [Chapter 13 — Psychological Disorders & Therapy](13-disorders-therapy.html) | The next chapter examines persistent distress and impairment without treating ordinary stress as diagnosis |
...
**affect labeling** — putting an emotional experience or emotional stimulus into words

**allostasis** — anticipatory adjustment that helps maintain stability under changing demands
...
**homeostasis** — feedback regulation that helps maintain internal conditions within viable ranges

**HPA axis** — the hypothalamic–pituitary–adrenal pathway culminating in cortisol release

**interoception** — sensing and integrating signals from inside the body

**primary appraisal** — evaluation of whether a situation is relevant, harmful, threatening, or challenging
...
- **Barrett, L. F. (2017). *How Emotions Are Made*.** [Publisher overview](https://www.hachettebookgroup.com/titles/lisa-feldman-barrett/how-emotions-are-made/9780544129962/) — An accessible statement of the constructionist framework that organizes this chapter.

- **Sapolsky, R. M. (2004). *Why Zebras Don't Get Ulcers* (3rd ed.).** [Publisher overview](https://us.macmillan.com/books/9780805073690/whyzebrasdontgetulcers/) — A memorable introduction to stress physiology and the problem of chronic symbolic threats.

- **McEwen, B. S. (1998). Protective and damaging effects of stress mediators.** [DOI record](https://doi.org/10.1056/NEJM199801153380307) — A concise foundation for allostatic load and the time-dependent effects of stress mediators.
