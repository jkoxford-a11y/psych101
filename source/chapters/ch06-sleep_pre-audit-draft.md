...
>
> **Note:** This file is a preserved standalone copy of `ch06-sleep.md` exactly as it stood immediately before the 2026-07-12 audit-reconciliation pass, kept for comparison purposes only. It is not linked into the book build and is not the authoritative chapter source — `ch06-sleep.md` is. See `GPT_project_log.md`'s "Chapter 6 Audit-Reconciliation Pass" entry for what changed and why.
